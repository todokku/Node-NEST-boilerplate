...
const mongo_point_to_lat_lng_interceptor_1 = require("./../../../shared/interceptors/mongo-point-to-lat-lng.interceptor");
...
__decorate([
    ...
    common_1.UseInterceptors(platform_express_1.FileInterceptor('image'), mongo_point_to_lat_lng_interceptor_1.MongoPointToLatLngInterceptor),
